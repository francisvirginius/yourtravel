...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'yourtavel_853e0fcf8506cd238153_20210702092148_archive.zip';
	const ARCHIVE_SIZE		 = '122573166';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '853e0fc-02092148';
    const SECONDARY_PACKAGE_HASH = 'a71e437-02092148';
	const VERSION			 = '1.4.1';
